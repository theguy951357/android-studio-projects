 ...
 */
public abstract class RoomFirebaseAdapter<ViewHolder extends RecyclerView.ViewHolder, T> extends RecyclerView.Adapter<ViewHolder> {
     ...
     */
    public RoomFirebaseAdapter(Query query) {
